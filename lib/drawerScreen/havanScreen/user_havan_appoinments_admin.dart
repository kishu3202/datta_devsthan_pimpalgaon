...
//
// class UserHavanBookingAdminScreen extends StatefulWidget {
//   const UserHavanBookingAdminScreen({super.key});
//
//   @override
//   State<UserHavanBookingAdminScreen> createState() =>
//       _UserHavanBookingAdminScreenState();
// }
//
// class _UserHavanBookingAdminScreenState extends State<UserHavanBookingAdminScreen> {
...
class UserHavanBookingAdminScreen extends StatefulWidget {
  const UserHavanBookingAdminScreen({super.key, this.userId});
  final String? userId;
...
class _UserHavanBookingAdminScreenState extends State<UserHavanBookingAdminScreen> {
  ...
  Widget build(BuildContext context) {
    final usersQuery = FirebaseFirestore.instance
        .collection('trust_users/${widget.userId}/appointments')
        .orderBy("bookingDate", descending: true);
    return Scaffold(
      appBar: AppBar(
        title: const Text('User Appointments (Admin)',
            style: TextStyle(color: Colors.white, fontSize: 18)),
        centerTitle: true,
      ),
      body: FirestoreListView<Map<String, dynamic>>(
